...
export default class Router extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        this.setState({ url: nextProps.url }, this.props.onUpdate ? () => this.props.onUpdate() : null);
    }
    ...
    routeTo(url) {
        this.setState({ url }, this.props.onUpdate ? () => this.props.onUpdate() : null);
    }
    render(props) {
        ...
        return createVNode(4 /* ComponentClass */, RouterContext, {
